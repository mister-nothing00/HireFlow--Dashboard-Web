    ...
    <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Accedi per continuare il tuo recruiting
        </p>
      </div>
      ...
      <div className="relative my-8">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-white text-gray-600">oppure</span>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <button
          disabled
          className="w-full py-3 border-2 border-gray-300 rounded-xl font-semibold text-gray-400 cursor-not-allowed flex items-center justify-center gap-2"
        >
          ...
          <span className="text-xs">(Presto)</span>
        </button>
